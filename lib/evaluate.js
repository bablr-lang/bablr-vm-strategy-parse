      ...
      switch (verb) {
        ...
        case 'shiftMatch': {
          ...
          if (
            ...
            let literalResult;
            let isIntrinsic =
              flags.token && !(parsedResolvedPath.flags.hasGap || mergedMatcher.flags.hasGap);
            ...
            if (shouldBranch(effects) && !literalValue) {
            ...
            if (shouldInterpolate) {
              ...
              start = buildOpenNodeTag(
                ...
                isLiteral && literalResult ? getCooked(literalResult) : null,
                isLiteral,
              );
            }
            ...
            if (isLiteral || shouldInterpolate) {
              ...
              if (shouldBranch(effects) && !matcher.nodeMatcher.literalValue) {
