      ...
      switch (verb) {
        ...
        case 'shiftMatch': {
          ...
          if (
            ...
            let mergedReference = ['#', '@'].includes(ownReference.type)
              ? ownReference
              : m.cover
              ? isNode
            ...
            mergedReference = buildReference(
              mergedReference.type,
              mergedReference.name,
              mergedReference.isArray,
              {
                ...mergedReference.flags,
                hasGap: gapsAllowed && mergedReference.flags.hasGap,
              },
            );
            ...
            const shouldInterpolate =
              ...
              !m.cover?.didShift &&
              (isNode || isCover) &&
              (parsedResolvedPath.flags.hasGap || mergedReference.flags.hasGap) &&
              !options?.suppressGap;
                  ...
                  : buildEmbeddedMatcher(
                      buildPropertyMatcher(
                        buildReferenceMatcher(
                          ...
                          mergedReference.name,
                          mergedReference.isArray,
                          buildReferenceFlags(mergedReference.flags),
                        ),
